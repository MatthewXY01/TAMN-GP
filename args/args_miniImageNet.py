...
def argument_parser():
    ...
    parser.add_argument('--train_categories', type=int, default=64)
    ...
    parser.add_argument('--LUT_lr', default=[(60, 0.05), (70, 0.006), (80, 0.0012), (90, 0.00024)],
    ...
    # Miscs
    # ************************************************************
    parser.add_argument('--save_dir', type=str, default='./result/miniImageNet/tamn/seed23/5w1s/')
    ...
    parser.add_argument('--num_episode_train', type=int, default=1200,
